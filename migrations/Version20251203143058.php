 ...
 */
final class Version20251203143058 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE task ADD status VARCHAR(255) DEFAULT "0%", ADD user_id_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE task DROP status, DROP user_id_id');
    }
}
